...
- Tier 1: Linux (`x86_64-unknown-linux-gnu`) with maintainer testing (Arch/Fedora) plus CI validation.
- Tier 2: macOS and Windows convenience binaries, validated in CI only (no maintainer manual testing).
